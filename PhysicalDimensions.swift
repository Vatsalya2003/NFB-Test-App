...
struct PhysicalDimensions {
   ...
   // static let intersectionRadiusMM: CGFloat = 2.5
    ...
    static func mmToGeographicRadius(_ mm: CGFloat, mapView: MKMapView) -> CLLocationDistance {
    ...
    private static func getScreenSizeInches() -> (width: Double, height: Double) {
     ...
     static func getCurrentDevicePPI() -> CGFloat {
        ...
        if identifier == "arm64" || identifier == "x86_64" || identifier.contains("Simulator") {
            ...
            print("Simulator Screen: \(screenWidth) × \(screenHeight)")
...
extension PhysicalDimensions {
    ...
    static func accessibleHitTarget(for mm: CGFloat) -> CGFloat {
